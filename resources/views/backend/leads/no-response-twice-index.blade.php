...
@section('title', '| Leads (No Response Twice)')

@section('breadcrumb')
    <div class="page-header">
        <h1 class="page-title">Leads (No Response Twice)</h1>
        <div>
            <ol class="breadcrumb">
                <li class="breadcrumb-item"><a href="{{ route('dashboard') }}">Dashboard</a></li>
                <li class="breadcrumb-item active" aria-current="page">Leads</li>
                <li class="breadcrumb-item active" aria-current="page">Leads (No Response Twice)</li>
            </ol>
        </div>
    </div>
@endsection
...
@section('content')
    <div class="card">
        <div class="card-header justify-content-between">
            <h3 class="card-title font-weight-bold">Leads (No Response Twice)</h3>
            <div>
...
@push('scripts')
    <script type='module'>
        ...
        const leadsNoResponseIndexUrl = '{{ route('leads.no-response-twice.index') }}';
        ...
        const noResponseTwiceStatusLabel = '{{ \App\Enums\StatusEnum::noResponseTwice()->label }}';
